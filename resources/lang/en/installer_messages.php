...
return [
    ...
    'environment' => [
        ...
        'wizard' => [
            ...
            'form' => [
                ...
                'app_name_label' => 'Site Name',
                'app_name_placeholder' => 'Asset Bee',
     ...
     */
    'installed' => [
        'success_log_message' => 'AssetBee successfully INSTALLED on ',
    ],
    ...
    'final' => [
        ...
        'env' => 'Final .env File:',
        'login_user' => "You can login with the user: admin@asset.bee",
        'login_pass' => "Add Password: assetbee",
